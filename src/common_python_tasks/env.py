...
_POETRY_DYNAMIC_VERSIONING_COMMANDS_ENV_VAR = "POETRY_DYNAMIC_VERSIONING_COMMANDS"
_AUTO_INJECTED_BUILD_ARG_ENV_VARS = (
    WORKDIR_PATH_ENV_VAR,
    _POETRY_DYNAMIC_VERSIONING_COMMANDS_ENV_VAR,
)
